...
import { DeleteOrderDetailRequest, GetOrderDetailRequest } from "../../redux-saga/action/orderDetailAction";
import FormikOrderDetailCreate from "./OrderDetailCreate";
import FormikOrderDetailEdit from "./OrderDetailEdit";
...
export default function OrderDetailSaga() {
  ...
  const onDelete = async (id: any) => {
    dispatch(DeleteOrderDetailRequest(id));
      ...
      <Layout>
        <>
          {displayEdit ? (
            ...
            <>
              <h2 className="mt-20 pb-4 ml-6">List Order Detail</h2>
                        ...
                        return (
                          <>
                            <tr className="border-b border-gray-200 dark:border-gray-700">
                              ...
                              <td className="px-4 py-4">{item.order ? item.order.id : null}</td>
                              <td className="px-4 py-4 bg-gray-50 dark:bg-gray-300">{item.product ? item.product.id : null}</td>
